      ...
      <main className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            About <span className="text-blue-600">TravelGenie</span>
          </h1>
        ...
        <div className="prose prose-lg prose-blue mx-auto">
          ...
          <ol className="mt-6 space-y-4">
            <li className="flex items-start">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-600 font-medium">1</span>
              <span className="ml-4">Tell us your destination, travel dates, and preferences</span>
            </li>
            <li className="flex items-start">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-600 font-medium">2</span>
              <span className="ml-4">Our AI analyzes millions of data points</span>
            </li>
            <li className="flex items-start">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-600 font-medium">3</span>
              <span className="ml-4">Receive a customized itinerary in seconds</span>
            </li>
            <li className="flex items-start">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-600 font-medium">4</span>
